...
public class spawner : MonoBehaviour
{
    ...
    public void Spawn()
    {
      ...
      //GameObject Spherespawn = Instantiate(SpherePrefabs[random], transform.position, Quaternion.identity); //instantiate a sphere prefab in spawner location
        GameObject Spherespawn = Instantiate(SpherePrefab, transform.position + new Vector3(1.0f,0.5f,0.0f), transform.rotation); // instantiate a sphere prefab with spawner's rotation
